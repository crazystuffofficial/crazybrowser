...
var win,array,iframe;window==top&&(win=window.open(),array=btoa(JSON.stringify([window.location.href,!1])),win.document.body.style.margin="0",win.document.body.style.height="100vh",(iframe=win.document.createElement("iframe")).style.border="none",iframe.style.width="100%",iframe.style.height="100%",iframe.style.margin="0",iframe.referrerpolicy="no-referrer",iframe.allow="fullscreen",iframe.src="/proxyRedirector.html#"+array,win.document.body.appendChild(iframe));
